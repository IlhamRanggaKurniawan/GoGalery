        ...
        <div className='p-2 w-full flex justify-center'>
            <div className='px-2 bg-card rounded-2xl w-full max-w-[500px]'>
                ...
                <div className='w-full'>
                    {type === "image" ? (
                        <Image src={contentUrl} alt={caption} width={1000} height={1000} onContextMenu={handleContextMenu} loading='lazy' className='rounded-xl w-full max-h-[600px] object-contain bg-black' />
                    ) : (
